<template>
  <section class="contacts">
    <a href="tel:+380666953745" target="_blank" v-animate-on-scroll>
    ...
    <a href="https://t.me/Hexagon14" target="_blank" v-animate-on-scroll>
      ...
      <span class="contact-text">@Hexagon14</span>
    </a>
    <a href="https://github.com/Hexagon-Dev" target="_blank" v-animate-on-scroll>
    ...
    <a href="https://discordapp.com/users/339861624209014786" target="_blank" v-animate-on-scroll>
      ...
      <span class="contact-text">Hexagon-Dev#8889</span>
    </a>
  </section>
</template>
